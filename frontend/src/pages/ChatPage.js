  ...
  return (
    <Container className="py-4">
      <Row className="mb-4 align-items-center">
        <Col>
          <h1 className="mb-0">Reading Assistant</h1>
          <p className="text-muted">Ask me anything about books or reading features</p>
        </Col>
        <Col xs="auto">
          <Link to="/" className="btn btn-outline-primary me-2">
            <i className="fas fa-home me-1"></i> Home
          </Link>
          <Button variant="outline-danger" onClick={handleClearChat}>
            <i className="fas fa-trash-alt me-1"></i> Clear Chat
          </Button>
        </Col>
      </Row>
      ...
      <Card className={`shadow-sm ${theme === 'dark' ? 'bg-dark text-light' : ''}`}>
        <Card.Body className="p-0">
          <div className="d-flex flex-column" style={{ height: 'calc(75vh)' }}>
            <div className="flex-grow-1 p-3 overflow-auto chat-scroll">
              ...
              {isBotTyping && (
                <div className="d-flex justify-content-start mb-3">
                  <div className="p-3 shadow-sm chat-message-bot" style={{ maxWidth: '75%' }}>
            ...
            <div className="border-top p-3">
              <Form onSubmit={handleSendMessage}>
                <div className="d-flex">
                  <Form.Control
                    type="text"
                    placeholder="Ask me about books or reading tools..."
                    value={userMessage}
              ...
              <div className="text-center mt-2">
                <small className="text-muted">Try asking about book recommendations, bookmarks, highlighting, or themes</small>
              </div>
            </div>
          </div>
        </Card.Body>
